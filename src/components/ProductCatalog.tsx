...
const ProductCatalog = () => {
  const categories = [
    ...
    },
    {
      ...
      count: "150+ styles",
      color: "from-sage-medium to-sage-light",
    },
    {
      title: "Sofas & Seating",
      ...
      count: "100+ pieces",
      color: "from-sage-dark to-sage-medium",
    },
    {
      title: "Lighting",
      ...
      count: "80+ fixtures",
      color: "from-warm-brown to-warm-beige",
    },
    {
      ...
      count: "300+ items",
      color: "from-sage-light to-sage-medium",
    },
    {
      title: "Complete Sets",
      ...
      count: "50+ bundles",
      color: "from-sage-medium to-warm-beige",
    },
  ];

  return (
    <section id="catalog" className="py-20 px-6 bg-gradient-to-b from-sage-medium to-sage-light">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((category, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-xl bg-sage-medium bg-opacity-80 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer backdrop-blur-md"
            >
              <div className="relative h-56 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <span className="bg-sage-medium bg-opacity-80 text-sage-dark px-3 py-1 rounded-xl text-sm font-light backdrop-blur-md border border-sage-medium border-opacity-20">
                    {category.count}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <p className="text-sage-dark mb-4 text-sm font-light">
