    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white px-6 max-w-4xl">
          <h2 className="text-5xl md:text-7xl font-semibold mb-6 animate-fade-in drop-shadow-2xl">
            {slides[currentSlide].title}
          </h2>
          <p className="text-xl md:text-2xl mb-8 opacity-90 animate-fade-in drop-shadow-lg max-w-2xl mx-auto font-light">
